...
class _GeneralLedgerScreenState extends ConsumerState<GeneralLedgerScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(generalLedgerDateToProvider.notifier).state =
          _toApiDate(_asOfDate!);
    });
  }
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                flex: 16,
                                child: MonetaryText(
                                  value: fmt.currency(l.openingBalance),
                                  fontSize: 13,
                                  textAlign: TextAlign.right,
                                ),
                              ),
                              Expanded(
                                flex: 16,
                                child: l.totalDebits > 0
                                    ? MonetaryText(
                                        value: fmt.currency(l.totalDebits),
                                        fontSize: 13,
                                        textAlign: TextAlign.right,
                                      )
                                    : Text(
                              ...
                              Expanded(
                                flex: 16,
                                child: l.totalCredits > 0
                                    ? MonetaryText(
                                        value: fmt.currency(l.totalCredits),
                                        fontSize: 13,
                                        textAlign: TextAlign.right,
                                      )
                                    : Text(
                              ...
                              Expanded(
                                flex: 16,
                                child: MonetaryText(
                                  value: fmt.currency(l.closingBalance),
                                  fontSize: 13,
