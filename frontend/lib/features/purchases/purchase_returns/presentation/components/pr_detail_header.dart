/// Purchase Return Detail Header — Top section with return info and actions.
library;
...
class PRDetailHeader extends StatelessWidget {
  const PRDetailHeader({
    super.key,
    required this.pr,
    this.onClose,
    this.onEdit,
...
class _InfoGrid extends StatelessWidget {
  const _InfoGrid({required this.pr});
  ...
  Widget build(BuildContext context) {
    ...
    final items = <_InfoItem>[
      _InfoItem(
        label: 'Return Date',
        value: _formatDate(pr.returnDate),
        icon: Icons.calendar_today,
      ),
      if (pr.billNumber.isNotEmpty)
        _InfoItem(
          label: 'Against Bill',
          value: pr.billNumber,
          icon: Icons.receipt_long,
        ),
      if (pr.posStateCode.isNotEmpty)
        _InfoItem(
          label: 'Place of Supply',
          value: pr.posStateCode,
          icon: Icons.location_on_outlined,
        ),
      if (pr.notes?.isNotEmpty == true)
        _InfoItem(
          label: 'Notes',
          value: pr.notes!,
