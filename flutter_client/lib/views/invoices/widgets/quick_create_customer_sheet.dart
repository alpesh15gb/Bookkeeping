...
class _QuickCreateCustomerSheet extends StatefulWidget {
  ...
  @override
  State<_QuickCreateCustomerSheet> createState() =>
  ...
  void _save() async {
    ...
    final contact = ContactModel(
      ...
      billingAddress: {
        'street': 'Not Provided',
        'city': 'Not Provided',
        'state': _stateNames[_stateCode] ?? 'Not Provided',
