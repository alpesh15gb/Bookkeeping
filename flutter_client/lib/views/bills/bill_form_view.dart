                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              border: Border.all(
                                color: state.hasError ? AppColors.error : (_selectedVendor != null ? AppColors.brandNavy.withValues(alpha: 0.4) : AppColors.border),
                                width: _selectedVendor != null ? 1.5 : 1,
                              ),
                              borderRadius: BorderRadius.circular(AppRadius.md),
                              color: _selectedVendor != null ? AppColors.brandNavy.withValues(alpha: 0.03) : null,
                            ),
                            child: Row(
                              children: [
                                CircleAvatar(
